...
<body>
    <div id="all">
        ...
        <div id="content">
            <div id="part1">
                <h1 style="font-size: 35px;">JavaScript Tutorial</h1>
                <div class="pre_next">
            ...
            <div id="part6">
                ...
                <br /><br />
                <b>Always</b> make sure you understand the "Try-it-Yourself" examples and exercises.
                <br /><br />
            </div>
            <hr />
            <div id="part7">
            <h1>JavaScript References</h1>
            <br /><br />
            ...
            <br /><br />
            <a href="#">Complete JavaScript Reference</a>
            <br /><br />
            </div>
            <hr />
            <div id="part8">
            <h1>JavaScript Quiz Test</h1>
            Test your JavaScript skills at W3Schools!
			<br /><br />
			<a href="#">Start JavaScript Quiz!</a> 
            <br /><br />
            </div>
            <hr />
            <div id="part9">
                <h1>JavaScript Exam - Get Your Diploma!</h1>
                <br /><br />
                ...
                <div id="cont9a" style="margin-left: 310px;">
