...
<body>
    <div id="all">
        ...
        <div id="content">
            <div id="part1">
                <h1 style="font-size: 35px;">CSS Tutorial</h1>
                <div class="pre_next">
            ...
            <div id="part6">
				...
				<br /><br />
                <a href="#">CSS Properties Reference</a>
                <br /><br />
                <a href="#">CSS Selectors Reference</a>
                <br /><br />
                <a href="#">CSS Aural Reference</a>
                <br /><br />
                <a href="#">CSS Units</a>
                <br /><br />
                <a href="#">CSS Color Reference</a>
            </div>
            <hr />
            <div id="part7">
                <h1>Exam - Get Your Diploma!</h1>
                <br /><br />
